...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/messenger/view.messenger.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loading = __webpack_require__(676);
	var noMessages = __webpack_require__(677);
	...
	module.exports = {
	  vuex: {
	    actions: {
	      sendMsg: _actions.sendMsg,
	      loadChat: _actions.loadChat,
	      toggleLockChat: _actions.toggleLockChat,
	      unloadChat: _actions.unloadChat,
	      updateMsgs: _actions.updateMsgs,
	      messageRead: _actions.messageRead,
	      loadChatList: _actions.loadChatList,
	      setConnectedUser: _actions.setConnectedUser
	    },
	    getters: {
	      isReady: _getters.isReady,
	      chatData: _getters.chatData,
	      messagesList: _getters.messagesList,
	      chatId: _getters.chatId,
	      userId: _getters.userId,
	  ...
	  methods: {
	    sendMessage: function sendMessage() {
	      ...
	      vm.sendMsg(this.chatId, vm.messageToSend, vm.chatData.participants);
	      vm.updateScroll(800);
	    },
	    ...
	    updateMessages: function updateMessages(o) {
	      var vm = this;
	      vm.reset();
	      vm.updateMsgs(o);
	      vm.updateScroll(800);
	    ...
	    getUserImageLink: function getUserImageLink(id) {
	      var vm = this;
	      return vm.chatData.participants[id].img;
	    },
	    updateScroll: function updateScroll(easeTime) {
	      window.$('#messages-block').animate({
	        scrollTop: window.$('#messages-block')[0].scrollHeight
	      }, easeTime, 'swing');
	    },
	    isApplicant: function isApplicant(uuid) {
	      var vm = this;
	      return vm.chatData.applicant.uuid === uuid;
	    },
	    isResponsible: function isResponsible(uuid) {
	      var vm = this;
	    ...
	    ownerName: function ownerName(uuid) {
	      var vm = this;
	      return vm.chatData.participants[uuid].name;
	    },
	    isDifferentOwner: function isDifferentOwner(uuid, index) {
	      var vm = this;
	      var keys = (0, _keys2.default)(vm.chatData.messages);
	    ...
	    showCard: function showCard(item) {
	      var vm = this;
	      var application = {
	        joboffer_id: vm.chatData.jobofferId,
	        id: item.owner
	      };
	  ...
	  route: {
	    data: function data(_ref) {
	      ...
	      var vm = this;
	      var _id = Number(to.params.id);
	      vm.unloadChat();
	      vm.loadChatList().then(function (chatList) {
	        vm.loading = false;
	        if (_id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".fixed[_v-1a24127a] {\n  position: fixed;\n  top: 64px;\n  bottom: 0px;\n  left: 0;\n  right: 0;\n}\n.full-height[_v-1a24127a] {\n  height: 100%;\n}\n.enlcosing[_v-1a24127a] {\n  min-width: 895px;\n}\n.from-right[_v-1a24127a] {\n  float: right;\n  text-align: right;\n}\n.chat-block[_v-1a24127a] {\n  background-color: #FFFFFF;\n  padding-top: 5px;\n}\n.chat-block .scrollable-block[_v-1a24127a] {\n  height: 90%;\n}\n.scrollable-block[_v-1a24127a] {\n  overflow-y: auto;\n  overflow-x: auto;\n  padding-right: 5px;\n}\n.clearfix[_v-1a24127a] {\n  display: inline-block;\n  width: 100%;\n}\n.chat-text[_v-1a24127a] {\n  padding: 10px;\n  border-radius: 15px;\n  max-width: 550px;\n  display: inline-block;\n}\n.self-chat-text-color[_v-1a24127a] {\n  background-color: #FF530D;\n  color: #FFFFFF;\n}\n.other-chat-text-color[_v-1a24127a] {\n  background-color: #383636;\n  color: #FFFFFF;\n}\n.applicant-chat-text-color[_v-1a24127a] {\n  background-color: #999999;\n  color: #FFFFFF;\n}\n.chat-image-with-name[_v-1a24127a] {\n  position: relative;\n  top: 20px;\n}\n.small-margin[_v-1a24127a] {\n  margin: 0 5px;\n}\n.message-input-block[_v-1a24127a] {\n  padding: 0 10px 0 10px;\n}\n.message-send-btn[_v-1a24127a] {\n  border-radius: 0 !important;\n  position: relative;\n  top: 9px;\n}\n.collection.col.s3[_v-1a24127a] {\n  margin: 0 !important;\n  border-right: 1px solid #E0E0E0;\n  padding: 0;\n}\n.non-read-background[_v-1a24127a] {\n  background-color: #F0F0FF;\n}\n.collection-item.avatar[_v-1a24127a]:hover {\n  cursor: pointer;\n}\n.small-font[_v-1a24127a] {\n  font-size: 11px;\n}\n.lock-icon[_v-1a24127a] {\n  position: absolute;\n  right: 5px;\n  top: 10px;\n}\n.lock-icon [_v-1a24127a]:hover {\n  color: #FF530D;\n}\n.lock-icon .lock-icon-locked[_v-1a24127a] {\n  color: #FF530D;\n}\n.open-job-offer[_v-1a24127a] {\n  position: absolute;\n  right: 5px;\n  bottom: 10px;\n}\n.open-job-offer [_v-1a24127a]:active {\n  color: #FF530D;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".wait-message[_v-3699a8f2] {\n  margin-top: 50px;\n  min-width: 10px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".no-message[_v-efe21bba] {\n  text-align: center;\n  margin-top: 50px;\n  min-width: 10px;\n  text-transform: capitalize;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1a24127a&scoped=true!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./view.messenger.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1a24127a&scoped=true!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./view.messenger.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3699a8f2&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./loading.messenger.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3699a8f2&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./loading.messenger.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-efe21bba&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./no-messages.messenger.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-efe21bba&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./no-messages.messenger.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n<section transition=\"fade-in\" class=\"row fixed\" _v-1a24127a=\"\">\n    <loading v-if=\"loading\" _v-1a24127a=\"\"></loading>\n    <div class=\"row full-height enlcosing\" v-else=\"\" _v-1a24127a=\"\">\n      <no-messages v-if=\"!messagesList.length\" _v-1a24127a=\"\"></no-messages>\n      <div class=\"row full-height\" v-else=\"\" _v-1a24127a=\"\">\n        <ul class=\"collection col s3 full-height scrollable-block\" _v-1a24127a=\"\">\n          <li class=\"collection-item avatar\" :class=\"{'non-read-background': isMessageNonRead(item.id)}\" v-for=\"item in messagesList\" track-by=\"$index\" @click=\"openMessage(item)\" _v-1a24127a=\"\">\n            <img v-if=\"item.applicant.uuid != userUUID\" :src=\"item.applicant.img\" alt=\"\" class=\"circle\" _v-1a24127a=\"\">\n            <img v-else=\"\" :src=\"item.company.logo\" alt=\"\" class=\"circle\" _v-1a24127a=\"\">\n            <span v-if=\"item.applicant.uuid != userUUID\" class=\"title\" _v-1a24127a=\"\">{{item.applicant.name}}</span>\n            <span v-else=\"\" class=\"title\" _v-1a24127a=\"\">{{item.company.name}}</span>\n            <p _v-1a24127a=\"\">{{item.title}}</p>\n            <span class=\"lock-icon\" v-if=\"isResponsible(item.responsible.uuid)\" @click=\"toggleLockChat(item)\" v-show=\"isReady\" _v-1a24127a=\"\">\n              <i v-if=\"item.state === 'open'\" class=\"material-icons\" _v-1a24127a=\"\"></i>\n              <i v-else=\"\" class=\"material-icons lock-icon-locked\" _v-1a24127a=\"\"></i>\n            </span>\n            <a class=\"open-job-offer\" v-link=\"'/joboffer/' + item.jobofferUUID\" target=\"_blank\" v-show=\"isReady\" _v-1a24127a=\"\">\n              <i class=\"material-icons\" _v-1a24127a=\"\"></i>\n            </a>\n          </li>\n        </ul>\n        <div class=\"col s9 chat-block full-height\" v-show=\"isReady\" _v-1a24127a=\"\">\n            <div class=\"scrollable-block\" id=\"messages-block\" _v-1a24127a=\"\">\n                <div class=\"clearfix\" v-for=\"item in chatData.messages\" track-by=\"$index\" _v-1a24127a=\"\">\n                    <div v-if=\"item.owner == userUUID\" class=\"fx-row from-right\" _v-1a24127a=\"\">\n                        <div class=\"row fx\" _v-1a24127a=\"\">\n                            <span class=\"small-font col s12 from-right\" v-if=\"isDifferentOwner(item.owner, $index)\" _v-1a24127a=\"\">{{ownerName(item.owner)}}</span>\n                            <p class=\"m-none text-right self-chat-text-color chat-text\" _v-1a24127a=\"\">{{item.content}}</p>\n                            <span class=\"small-font col s12\" _v-1a24127a=\"\">{{item.timestamp | time}}</span>\n                        </div>\n                        <img :src=\"getUserImageLink(item.owner)\" class=\"circle size-32 fx-end small-margin chat-image-with-name\" v-if=\"isDifferentOwner(item.owner, $index)\" @click=\"showCard(item)\" _v-1a24127a=\"\">\n                        <img :src=\"getUserImageLink(item.owner)\" class=\"circle size-32 fx-end small-margin\" v-else=\"\" @click=\"showCard(item)\" _v-1a24127a=\"\">\n                    </div>\n                    <div v-else=\"\" class=\"fx-row\" _v-1a24127a=\"\">\n                        <img :src=\"getUserImageLink(item.owner)\" class=\"circle size-32 fx small-margin chat-image-with-name\" v-if=\"isDifferentOwner(item.owner, $index)\" @click=\"showCard(item)\" _v-1a24127a=\"\">\n                        <img :src=\"getUserImageLink(item.owner)\" class=\"circle size-32 fx small-margin\" v-else=\"\" @click=\"showCard(item)\" _v-1a24127a=\"\">\n                        <div class=\"row fx-end\" _v-1a24127a=\"\">\n                            <span class=\"small-font col s12\" v-if=\"isDifferentOwner(item.owner, $index)\" _v-1a24127a=\"\">{{ownerName(item.owner)}}</span>\n                            <p v-if=\"isApplicant(item.owner)\" class=\"m-none chat-text applicant-chat-text-color\" _v-1a24127a=\"\">{{item.content}}</p>\n                            <p v-else=\"\" class=\"m-none chat-text other-chat-text-color\" _v-1a24127a=\"\">{{item.content}}</p>\n                            <span class=\"small-font col s12\" _v-1a24127a=\"\">{{item.timestamp | time}}</span>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <hr _v-1a24127a=\"\">\n            <form class=\"col s12 message-input-block\" v-on:submit.prevent=\"sendMessage()\" _v-1a24127a=\"\">\n                <div class=\"row\" flex=\"\" _v-1a24127a=\"\">\n                    <input v-model=\"messageToSend\" type=\"text\" class=\"col s11\" v-bind:disabled=\"chatData.state === 'locked'\" v-bind:placeholder=\"chatData.state === 'locked' ? 'The chat is locked by the responsible :(' : 'Type your message ...'\" _v-1a24127a=\"\">\n                    <button class=\"btn message-send-btn col s1\" type=\"button\" v-on:keyup.enter=\"sendMessage()\" :class=\"{'disabled': chatData.state === 'locked'}\" v-on:click=\"sendMessage()\" _v-1a24127a=\"\">\n                        <i style=\"color: #FFFFFF\" class=\"material-icons\" _v-1a24127a=\"\"></i>\n                    </button>\n                </div>\n            </form>\n        </div>\n      </div>\n    </div>\n</section>\n\n";
...
/***/ function(module, exports) {
	...
	module.exports = "\n<section class=\"row\" _v-3699a8f2=\"\">\n\t<div class=\"col s6 wait-message\" _v-3699a8f2=\"\"></div>\n\t<div class=\"col s6 wait-message\" _v-3699a8f2=\"\">\n\t\t<div class=\"preloader-wrapper big active\" _v-3699a8f2=\"\">\n\t\t\t<div class=\"spinner-layer spinner-blue\" _v-3699a8f2=\"\">\n\t\t\t\t<div class=\"circle-clipper left\" _v-3699a8f2=\"\">\n\t\t\t\t\t<div class=\"circle\" _v-3699a8f2=\"\"></div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"gap-patch\" _v-3699a8f2=\"\">\n\t\t\t\t\t<div class=\"circle\" _v-3699a8f2=\"\"></div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"circle-clipper right\" _v-3699a8f2=\"\">\n\t\t\t\t\t<div class=\"circle\" _v-3699a8f2=\"\"></div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</section>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "\n<section class=\"row\" _v-efe21bba=\"\">\n\t<div class=\"col s2 no-message\" _v-efe21bba=\"\">.</div>\n\t<div class=\"col s8 no-message\" _v-efe21bba=\"\">\n\t\tno messages dude :( forever alone we stand, united we fall...\t\n\t</div>\n\t<div class=\"col s2 no-message\" _v-efe21bba=\"\">.</div>\n\t\n</section>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_template__ = __webpack_require__(626)
	module.exports = __vue_script__ || {}
	if (module.exports.__esModule) module.exports = module.exports.default
	if (__vue_template__) {
	(typeof module.exports === "function" ? (module.exports.options || (module.exports.options = {})) : module.exports).template = __vue_template__
