...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.sendInvitation = exports.loadJoboffers = undefined;
	...
	var loadJoboffers = exports.loadJoboffers = function loadJoboffers(_ref) {
	  ...
	  var options = { limit: state.timeline.limit, page: state.timeline.page };
	  return new _promise2.default(function (resolve, reject) {
	    connect.apiCall(options, '/joboffers', 'GET', function (err, res, header) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getters = __webpack_require__(383);
	...
	module.exports = {
	  vuex: {
	    ...
	    getters: {
	      joboffers: _getters.timelineData,
	      isReady: _getters.isReady
	    }
	  },
	  data: function data() {
	  ...
	  methods: {
	    hidetyper: function hidetyper() {
	      console.log('hiding');
	      this.showtyper = false;
	      $('#searchinput').show().focus().val(' ');
	    },
	  ...
	  ready: function ready() {
	    ...
	    $('#searchinput').keypress(function (e) {
	      if (e.which == 13) {
	        ...
	        $('html, body').animate({ scrollTop: $('#job-offers-list').offset().top }, {
	          complete: function complete() {
	            if (!completeCalled) {
	              completeCalled = true;
	              console.log('this alert will popup once');
	            }
	          }
	        });
	        return false;
	    ...
	    var header = $('#job-offers-list');
	    header.css({ 'opacity': 0 });
	    var onScrollFlag = true;
	    $(window).on('scroll', function () {
	      ...
	      if (scrollTop >= offset) {
	        $('#search-top-screen').remove();
	        header.css({ 'opacity': 1 });
	        onScrollFlag = false;
	        window.scrollTo(0, 0);
	      }
	      header.css({ 'opacity': scrollTop / offset });
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\nhtml, body, #app { height:100%; }\n.box { height:100%; }\n#search-top-screen { position: relative; }\n#job-offers-list {    }\n/* ==========================================================================\nGrid Overlay Styles\nAuthor: Steve Hickey | http://stevehickeydesign.com\nCompany: Fresh Tilled Soil | http://freshtilledsoil.com\n========================================================================== */\ndiv#gridOverlay {\n\n  position: absolute;;\n  z-index: 10;\n  top: 0; right: 0; bottom: 0; left: 0;\n  width: 100%;\n  margin: 0 auto;\n  background:url(\n    data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAJklEQVQIW2NkYGD4r6CgMIsBChgVFBRmwjggGi7w4MGDNJBKDBUAL/cI6VRh8RwAAAAASUVORK5CYII=\n    ) repeat;\n}\n\n.fullscreen-bg {\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  overflow: hidden;\n  z-index: -100;\n}\n\n.fullscreen-bg__video {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n}\n\n@media (min-aspect-ratio: 16/9) {\n  .fullscreen-bg__video {\n    height: 300%;\n    top: -100%;\n  }\n}\n\n@media (max-aspect-ratio: 16/9) {\n  .fullscreen-bg__video {\n    width: 300%;\n    left: -100%;\n  }\n}\n\n@media (max-width: 767px) {\n  .fullscreen-bg {\n    background: url('/static/videos/ocean.jpg') center center / cover no-repeat;\n  }\n\n  .fullscreen-bg__video {\n    display: none;\n  }\n}\n\n    .typed-cursor{\n        opacity: 1;\n        -webkit-animation: blink 0.7s infinite;\n        animation: blink 0.7s infinite;\n    }\n    @keyframes blink{\n        0% { opacity:1; }\n        50% { opacity:0; }\n        100% { opacity:1; }\n    }\n    @-webkit-keyframes blink{\n        0% { opacity:1; }\n        50% { opacity:0; }\n        100% { opacity:1; }\n    }\n    .type-container{\n      position: absolute;\n      color: #828587;\n      font-size: 24px;\n      z-index: 9999;\n      width: 100%;\n      height: 100%;\n      /*font-family: 'Ubuntu Condensed', sans-serif;*/\n\n    }\n\n\n\n    #inner-container{\n      padding-top:20%;\n    }\n\n    .searchbox{\n      background-color: rgba(232, 232, 232, .8);\n      padding: 20px 0;\n      box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.1) inset, 0px 0px 8px rgba(230, 230, 230, 0.6);\n    }\n\n    #search-icon{\n      width: 34px;\n      margin-top: -9px;\n      margin-left: 30px;\n    }\n    .category-selector{\n      border-left: 1px solid;\n    }\n    .mdl-textfield{\n      padding: 0 !important;\n    }\n\n    #searchinput{\n      background-color: rgba(0, 0, 0, 0.01);\n      border: none;\n      color: #828587;\n      font-size: 24px;\n      /*font-family: 'Ubuntu Condensed', sans-serif;*/\n    }\n\n\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./view.search.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./view.search.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/svg+xml;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "\n\n  <div id=\"search-top-screen valign-wrapper\" class=\"box \">\n\n      <div class=\"fullscreen-bg\">\n        <video loop muted autoplay poster=\"static/videos/ocean.jpg\" class=\"fullscreen-bg__video\">\n          <source src=\"static/videos/12322181.webm\" type=\"video/webm\">\n          <source src=\"static/videos/12322181.mp4\" type=\"video/mp4\">\n          <source src=\"static/videos/12322181.ogv\" type=\"video/ogg\">\n        </video>\n      </div>\n      <div id='gridOverlay'></div>\n      <!-- Search and Typring Container -->\n\n      <div  class=\"row type-container font-light\">\n      <div id=\"inner-container\">\n      <!-- Search Box -->\n          <div class=\"wrap searchbox col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3\">\n              <div class=\"type-wrap row p-none\">\n                <div class=\"col-md-1 m-none p-none\"><img id=\"search-icon\" src=\"" + __webpack_require__(576) + "\" /></div>\n      <!-- Typewriter -->\n                <div class=\"col-md-8  \">\n                  <div v-if=\"showtyper\" @click=\"hidetyper()\" class=\" \">\n                      <span>Search for your </span>\n                      <span id=\"typed-strings\">\n                          <p><strong>next</strong></p>\n                          <p><span style=\"color:#FF6633\">dream</span> job</p>\n                      </span>\n                      <span id=\"typed\" style=\"white-space:pre;\"></span>\n                  </div>\n                  <input placeholder=\"Search for your dream job\" v-show=\"!showtyper\" id=\"searchinput\" type=\"text\" maxlength=\"32\" v-model=\"searchkey\" class=\"form-control  p-none m-l-n-xs m-t-n-xs pos-ab\">\n                </div>\n     \n      </div>\n      </div>\n        </div>\n        <!-- End of Search and Typring Container -->\n\n  </div>\n  <div id=\"job-offers-list\"  class=\"box m-none p-none\" style=\"background-color:#f1f3f6;min-height:1000px;\"   >\n    <div id=\"header\">\n      <topnav></topnav>\n      <section class=\"row p-none m-none  page-container\" style=\"margin-top:0 !important;\">\n        <div class=\"col-md-4\">\n            <advanced-filter></advanced-filter>\n        </div>\n\n        <div class=\"col-md-8 \"  >\n          <apply></apply>\n          <share></share>\n          <div style=\"height:80px;\"></div>\n          <div class=\"p-none p-r-xs hpanel  p-b-lg  \" >\n              <joboffer class=\"m-b-sm\" v-for=\"item in joboffers\" :data=\"item\" :current=\"profile\"></joboffer>\n          </div>\n        </div>\n        <div class=\"col-md-2\"></div>\n      </section>\n    </div>\n    <div class='p-none to-animate p-r-sm'>\n        <router-view transition-mode='out-in'></router-view>\n    </div>\n  </div>\n\n</template>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/home/view.search.vue: named exports in *.vue files are ignored.")}
