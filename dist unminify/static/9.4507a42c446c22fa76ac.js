...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./speech.bubble.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./speech.bubble.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _top_nav = __webpack_require__(102);
	...
	module.exports = {
	  ...
	  methods: {
	    check: function check() {
	      ...
	      this.loadCompany().then(function (res) {
	        var id = res.slug ? res.slug : res.uuid;
	        _this.$route.router.replace({
	          name: 'company',
	          params: { id: id }
	        });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/company/index.company.vue: named exports in *.vue files are ignored.")}
