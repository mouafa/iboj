...
/***/ function(module, exports, __webpack_require__) {
	...
	var accountData = _require.accountData;
	...
	module.exports = {
	  ...
	  methods: {
	    save: function save() {
	      if (!this.currentpassword) this.notify('error', 'You must enter your current password in order to change it.');else if (!this.newpassword) this.notify('error', 'You must enter your new password.');else this.saveChange();
	    },
	    saveChange: function saveChange() {
	      ...
	      connector.apiCall(data, '/auth/change', 'POST', function (err, resp) {
	        if (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/settings/index.setting.vue: named exports in *.vue files are ignored.")}
