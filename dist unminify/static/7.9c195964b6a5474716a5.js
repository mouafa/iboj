...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  ready: function ready() {
	    ...
	    bus.$on('joboffer:rec-state-changed', function (data) {
	      return _this.details.historyable.$set(_this.details.historyable.length, data);
	    });
	  },
	  destroyed: function destroyed() {
	  ...
	  methods: {
	    showCard: function showCard(application) {
	      console.log(application.id, application.joboffer_id);
	    ...
	    hideCard: function hideCard(argument) {
	      this.details = null;
	      this.showme = false;
	    },
	    ...
	    getRecommend: function getRecommend(_recomId_) {
	      var vm = this;
	      var jobId = this.jobId;
	      connector.apiAsync('GET', '/dashboard/joboffers/' + jobId + '/recommendations/' + _recomId_).then(function (res) {
	        vm.details = res;
	    ...
	    editComment: function editComment() {
	      var _backup = void 0;
	      var _comment = this.$els.comment.innerText || ' ';
	      if (!this.editable) {
	        this.editable = true;
	        _backup = _comment;
	      } else {
	    ...
	    sendComment: function sendComment(_new_, _old_) {
	      var vm = this;
	      connector.apiCall({
	        comment: _new_
	      }, '/dashboard/joboffers/' + this.jobId + '/recommendations/' + this.recomId + '/comment', 'POST', function (error, response) {
	        if (error) vm.$els.comment.innerText = _old_;
	      });
	    },
	    gotoProfile: function gotoProfile(condidate) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*doc\n---\ntitle: Colors\nname: colors\ncategory: Base CSS\n---\n\nColors: to be able to use the predefined colors, You need to import common/less/colors.less\n\n```html_example\n<style>\n@import \"../src/components/common/less/colors.less\"\n</style>\n<div class=\"size-32\" style=\"background-color: @color-navy-blue\">Click</div>\n```\n*/\n/* Mixin */\n.dropdown[_v-518e5caa] {\n  position: relative;\n}\n.dropdown-menu[_v-518e5caa] {\n  position: absolute;\n  top: 100%;\n  left: 0;\n  z-index: 1000;\n  display: none;\n  float: left;\n  min-width: 160px;\n  padding: 5px 0;\n  margin: 2px 0 0;\n  font-size: 14px;\n  text-align: left;\n  list-style: none;\n  background-color: #fff;\n  background-clip: padding-box;\n  border: 1px solid #ccc;\n  border: 1px solid rgba(0, 0, 0, 0.15);\n  border-radius: 4px;\n  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.175);\n}\n.open > .dropdown-menu[_v-518e5caa] {\n  display: block;\n}\n.slide-transition[_v-518e5caa] {\n  -webkit-transition: all .3s ease;\n  transition: all .3s ease;\n  overflow: hidden;\n  -webkit-animation: slideInRight 300ms ease;\n          animation: slideInRight 300ms ease;\n}\n.slide-enter[_v-518e5caa],\n.slide-leave[_v-518e5caa] {\n  -webkit-animation: slideOutRight 300ms ease;\n          animation: slideOutRight 300ms ease;\n}\n@-webkit-keyframes slideInRight {\n  from {\n    -webkit-transform: translate3d(100%, 0, 0);\n            transform: translate3d(100%, 0, 0);\n    visibility: visible;\n  }\n  to {\n    -webkit-transform: translate3d(0, 0, 0);\n            transform: translate3d(0, 0, 0);\n  }\n}\n@keyframes slideInRight {\n  from {\n    -webkit-transform: translate3d(100%, 0, 0);\n            transform: translate3d(100%, 0, 0);\n    visibility: visible;\n  }\n  to {\n    -webkit-transform: translate3d(0, 0, 0);\n            transform: translate3d(0, 0, 0);\n  }\n}\n@-webkit-keyframes slideOutRight {\n  from {\n    -webkit-transform: translate3d(0, 0, 0);\n            transform: translate3d(0, 0, 0);\n  }\n  to {\n    visibility: hidden;\n    -webkit-transform: translate3d(100%, 0, 0);\n            transform: translate3d(100%, 0, 0);\n  }\n}\n@keyframes slideOutRight {\n  from {\n    -webkit-transform: translate3d(0, 0, 0);\n            transform: translate3d(0, 0, 0);\n  }\n  to {\n    visibility: hidden;\n    -webkit-transform: translate3d(100%, 0, 0);\n            transform: translate3d(100%, 0, 0);\n  }\n}\n.recomm-card[_v-518e5caa] {\n  position: fixed;\n  bottom: 0;\n  right: 0;\n  top: 0;\n  z-index: 1000;\n  width: 350px;\n}\n.recomm-card ul[_v-518e5caa] {\n  list-style: none;\n  padding: 0;\n}\n.recomm-card h2[_v-518e5caa] {\n  font-size: normal;\n}\n.recomm-card .social[_v-518e5caa] {\n  border-radius: 40px;\n  color: white;\n  padding: 1px 8px;\n  -webkit-transition: -webkit-transform 200ms ease;\n  transition: -webkit-transform 200ms ease;\n  transition: transform 200ms ease;\n  transition: transform 200ms ease, -webkit-transform 200ms ease;\n  -webkit-transform: scale(0.9);\n          transform: scale(0.9);\n}\n.recomm-card .social[_v-518e5caa]:hover {\n  -webkit-transform: scale(1);\n          transform: scale(1);\n}\n.recomm-card .social i[_v-518e5caa] {\n  margin-right: 4px;\n  display: inline-block !important;\n}\n.recomm-card .social.-tw[_v-518e5caa] {\n  background-color: #00aced;\n}\n.recomm-card .social.-fb[_v-518e5caa] {\n  background-color: #3b5998;\n}\n.recomm-card .social.-in[_v-518e5caa] {\n  background-color: #0077b5;\n}\n.recomm-card .rc-container .rc-nav[_v-518e5caa] {\n  display: none;\n  background: red;\n  height: 100%;\n  position: absolute;\n  top: 40px;\n  left: 40px;\n  z-index: 1000;\n}\n.recomm-card .rc-container .rc-nav button[_v-518e5caa] {\n  background: #bbbbbb;\n  border-radius: 50%;\n  padding: 14px 14px 13px 14px;\n  width: 12px;\n  height: 12px;\n}\n.recomm-card .rc-container .rc-content[_v-518e5caa] {\n  max-width: 350px;\n  width: 100%;\n  height: 100%;\n  right: 0;\n  position: absolute;\n  overflow-y: auto;\n  background: white;\n}\n.recomm-card .rc-container .rc-content .close-btn[_v-518e5caa] {\n  border-radius: 50%;\n  width: 34px;\n  height: 34px;\n  padding: 0;\n  position: fixed;\n  right: 20px;\n  top: 26px;\n}\n.recomm-card .rc-container .rc-content label[_v-518e5caa] {\n  display: block;\n  font-weight: normal;\n}\n.recomm-card .rc-container .rc-content label b[_v-518e5caa] {\n  display: inline-block;\n  line-height: 2.8rem;\n}\n.recomm-card .rc-container .rc-content label b.__active[_v-518e5caa] {\n  border-bottom: 2px solid #6a6c6f;\n}\n.recomm-card .rc-container .rc-content .timeline .tl-item[_v-518e5caa] {\n  padding-left: 14px;\n  padding-bottom: 20px;\n  position: relative;\n}\n.recomm-card .rc-container .rc-content .timeline .tl-item[_v-518e5caa]:before {\n  content: '';\n  position: absolute;\n  top: 3px;\n  bottom: 0;\n  left: 1px;\n  display: block;\n  width: 2px;\n  background-color: #e4e5e7;\n}\n.recomm-card .rc-container .rc-content .timeline .tl-item[_v-518e5caa]:last-child:before {\n  display: none;\n}\n.recomm-card .rc-container .rc-content .timeline .tl-item .tl-head[_v-518e5caa] {\n  margin-top: -4px;\n}\n.recomm-card .rc-container .rc-content .timeline .tl-item .tl-head[_v-518e5caa]:before {\n  content: '';\n  position: absolute;\n  top: 3px;\n  left: -3px;\n  display: block;\n  width: 10px;\n  height: 10px;\n  border-radius: 50%;\n  border: #e4e5e7 2px solid;\n  background-color: #6a6c6f;\n}\n.recomm-card .rc-container .rc-content .rc-comment[_v-518e5caa] {\n  -webkit-transition: all 200ms ease;\n  transition: all 200ms ease;\n  border: 1px solid white;\n  padding: 6px 4px;\n  border-radius: 2px;\n  min-height: 30px;\n}\n.recomm-card .rc-container .rc-content .rc-comment[contentEditable=\"true\"][_v-518e5caa] {\n  border-color: #06a2c4;\n  box-shadow: inset 0 0 4px 2px #e4e5e7;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-518e5caa&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./recommended.side.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-518e5caa&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./recommended.side.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n\n<div v-show=\"showme\" _v-518e5caa=\"\">\n  <div class=\"recomm-card\" transition=\"slide\" v-if=\"details\" _v-518e5caa=\"\">\n    <div class=\"rc-container fx-row fx-space-between\" _v-518e5caa=\"\">\n      <section class=\"rc-nav fx-column fx\" _v-518e5caa=\"\">\n        <button class=\"btn\" _v-518e5caa=\"\">\n          <span _v-518e5caa=\"\">\n            <svg height=\"12\" viewBox=\"0 0 12 12\" width=\"12\" xmlns=\"http://www.w3.org/2000/svg\" _v-518e5caa=\"\">\n              <path d=\"M6 4.586l4.24-4.24c.395-.395 1.026-.392 1.416-.002.393.393.39 1.024 0 1.415L7.413 6l4.24 4.24c.395.395.392 1.026.002 1.416-.393.393-1.024.39-1.415 0L6 7.413l-4.24 4.24c-.395.395-1.026.392-1.416.002-.393-.393-.39-1.024 0-1.415L4.587 6 .347 1.76C-.05 1.364-.048.733.342.343c.393-.393 1.024-.39 1.415 0L6 4.587z\" fill-rule=\"evenodd\" _v-518e5caa=\"\"></path>\n            </svg>\n          </span>\n        </button>\n        <button class=\"btn\" _v-518e5caa=\"\">\n          <span _v-518e5caa=\"\">\n            <svg height=\"11\" viewBox=\"0 0 7 11\" width=\"7\" xmlns=\"http://www.w3.org/2000/svg\" _v-518e5caa=\"\">\n              <path d=\"M.256 5.498c0-.255.098-.51.292-.703L4.795.548C5.18.163 5.817.16 6.207.55c.393.393.392 1.023.002 1.412L2.67 5.5l3.54 3.538c.384.384.388 1.02-.003 1.412-.393.393-1.023.39-1.412.002L.548 6.205c-.192-.192-.29-.447-.29-.702z\" fill-rule=\"evenodd\" fill=\"#948B88\" _v-518e5caa=\"\"></path>\n            </svg>\n          </span>\n        </button>\n        <button class=\"btn\" _v-518e5caa=\"\">\n          <span _v-518e5caa=\"\">\n            <svg height=\"11\" viewBox=\"0 0 7 11\" width=\"7\" xmlns=\"http://www.w3.org/2000/svg\" _v-518e5caa=\"\">\n              <path d=\"M6.744 5.502c0 .255-.098.51-.292.703l-4.247 4.247c-.385.385-1.022.388-1.412-.002C.4 10.057.4 9.427.79 9.038L4.33 5.5.79 1.962C.407 1.578.403.942.794.55 1.186.157 1.816.16 2.204.548l4.248 4.247c.192.192.29.447.29.702z\" fill-rule=\"evenodd\" fill=\"#948B88\" _v-518e5caa=\"\"></path>\n            </svg>\n          </span>\n        </button>\n      </section>\n\n      <section class=\"rc-content border-left p-m\" _v-518e5caa=\"\">\n        <a @click=\"hideCard\" class=\"btn-floating btn waves-effect waves-light red pull-right\" _v-518e5caa=\"\"><i class=\"material-icons\" _v-518e5caa=\"\"></i></a>\n<!--         <button @click=\"hideCard\" class=\"btn close-btn btn-default fx-rox fx-center-center\">\n          <svg height=\"12\" viewBox=\"0 0 12 12\" width=\"12\" xmlns=\"http://www.w3.org/2000/svg\">\n            <path d=\"M6 4.586l4.24-4.24c.395-.395 1.026-.392 1.416-.002.393.393.39 1.024 0 1.415L7.413 6l4.24 4.24c.395.395.392 1.026.002 1.416-.393.393-1.024.39-1.415 0L6 7.413l-4.24 4.24c-.395.395-1.026.392-1.416.002-.393-.393-.39-1.024 0-1.415L4.587 6 .347 1.76C-.05 1.364-.048.733.342.343c.393-.393 1.024-.39 1.415 0L6 4.587z\" fill-rule=\"evenodd\"></path>\n          </svg>\n        </button> -->\n\n        <div class=\"fx-row fx-start-center\" v-if=\"condidate\" _v-518e5caa=\"\">\n          <img @click=\"gotoProfile(condidate)\" :src=\"condidate.img\" alt=\"user\" class=\"user-image img-circle border size-48 hand\" _v-518e5caa=\"\">\n          <div class=\"m-l-sm\" _v-518e5caa=\"\">\n            <div _v-518e5caa=\"\">\n              <a _v-518e5caa=\"\"><h5 @click=\"gotoProfile(condidate)\" class=\"jdh--title capital m-none hand\" _v-518e5caa=\"\">{{condidate.firstname}} {{condidate.lastname}}</h5></a>\n              <h6 class=\"capital m-none\" _v-518e5caa=\"\">{{condidate.title}}</h6>\n            </div>\n          </div>\n        </div>\n\n        <div class=\"fx-row m-t-sm\" v-if=\"condidate\" _v-518e5caa=\"\">\n          <a class=\"btn social -tw m-r-xs\" href=\"http://fb.com/{{condidate.fbLink}}\" target=\"_blank\" v-if=\"condidate.fbLink\" _v-518e5caa=\"\">\n            <i class=\"fa fa-twitter\" _v-518e5caa=\"\"></i>\n            <span class=\"capital\" v-ii18n=\"twitter\" _v-518e5caa=\"\">twitter</span>\n          </a>\n          <a class=\"btn social -fb m-r-xs\" href=\"http://twitter.com/{{condidate.twitterLink}}\" target=\"_blank\" v-if=\"condidate.twitterLink\" _v-518e5caa=\"\">\n            <i class=\"fa fa-facebook-official\" _v-518e5caa=\"\"></i>\n            <span class=\"capital\" v-ii18n=\"facebook\" _v-518e5caa=\"\">facebook</span>\n          </a>\n          <a class=\"btn social -in m-r-xs\" href=\"http://linkedin.com/in/{{condidate.LinkedInLink}}\" target=\"_blank\" v-if=\"condidate.LinkedInLink\" _v-518e5caa=\"\">\n            <i class=\"fa fa-linkedin\" _v-518e5caa=\"\"></i>\n            <span class=\"capital\" v-ii18n=\"linkedin\" _v-518e5caa=\"\">linkedin</span>\n          </a>\n        </div>\n\n        <div class=\"m-t-sm\" v-if=\"condidate\" _v-518e5caa=\"\">\n          <label class=\"border-bottom\" _v-518e5caa=\"\">\n            <b class=\"capital __active\" v-ii18n=\"about\" _v-518e5caa=\"\">about</b>\n          </label>\n          <p class=\"m-none m-b-xs\" _v-518e5caa=\"\">{{condidate.about}}</p>\n        </div>\n\n        <div class=\"fx-row fx-start-center\" _v-518e5caa=\"\">\n          <h4 class=\"capital m-r-sm\" _v-518e5caa=\"\">\n            <span v-ii18n=\"status\" _v-518e5caa=\"\">status</span>\n          </h4>\n          <status :recom-id=\"recomId\" :recommendation=\"details\" _v-518e5caa=\"\"></status>\n        </div>\n\n        <div class=\"m-t-sm\" _v-518e5caa=\"\">\n          <label class=\"border-bottom\" _v-518e5caa=\"\">\n            <b class=\"capital __active m-r-xs\" v-ii18n=\"logs\" _v-518e5caa=\"\">logs</b>\n            <i v-if=\"details.commentable[0]\" _v-518e5caa=\"\">{{details.commentable[0].updated_at | moment \"from\" \"now\"}}</i>\n              <span @click=\"editComment\" type=\"button\" class=\"pull-right hand\" _v-518e5caa=\"\">\n              <i v-if=\"!editable\" class=\"material-icons\" _v-518e5caa=\"\"></i>\n              <i v-if=\"editable\" class=\"material-icons\" _v-518e5caa=\"\"></i>\n                 {{editable ? 'Save' : 'Edit'}}\n            </span>\n          </label>\n          <p v-if=\"details.commentable[0]\" class=\"m-none m-b-xs rc-comment\" contenteditable=\"{{editable}}\" v-el:comment=\"\" _v-518e5caa=\"\">{{details.commentable[0].comment}}</p>\n          <p v-else=\"\" class=\"m-none m-b-xs rc-comment\" contenteditable=\"{{editable}}\" v-el:comment=\"\" _v-518e5caa=\"\"></p>\n        </div>\n\n        <div v-if=\"details.historyable &amp;&amp; details.historyable.length\" class=\"m-t-sm\" _v-518e5caa=\"\">\n          <label class=\"border-bottom\" _v-518e5caa=\"\">\n            <b class=\"capital __active m-r-xs\" v-ii18n=\"history\" _v-518e5caa=\"\">history</b>\n          </label>\n          <ul class=\"timeline\" _v-518e5caa=\"\">\n            <li class=\"tl-item\" track-by=\"$index\" v-for=\"history in details.historyable\" _v-518e5caa=\"\">\n              <div class=\"tl-head fx-row fx-start-center\" _v-518e5caa=\"\">\n                <h4 class=\"m-none capital p-r-xs\" _v-518e5caa=\"\">{{history.item}}\n                  <span class=\"font-9\" v-ii18n=\"changed\" _v-518e5caa=\"\">changed</span>\n                </h4>\n                <i _v-518e5caa=\"\">\n                  {{history.updated_at | moment \"from\" \"now\"}}</i>\n              </div>\n              <p class=\"capital m-none m-t-xs\" _v-518e5caa=\"\">\n                <span v-ii18n=\"changedFrom\" _v-518e5caa=\"\">changed from</span>\n                <b _v-518e5caa=\"\">{{history.oldvalue}}</b>\n                to\n                <b _v-518e5caa=\"\">{{history.newvalue}}</b>\n              </p>\n            </li>\n          </ul>\n        </div>\n\n      </section>\n\n    </div>\n\n  </div>\n</div>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/recommended.side.vue: named exports in *.vue files are ignored.")}
	...
	module.exports = {
	  ...
	  data: function data() {
	    return {
	      ...
	      joboffer: null,
	      isLoading: false,
	      contactname: function contactname(e) {
	  ...
	  computed: {
	    verifExistance: function verifExistance() {
	      if (this.collaborator) {
	        if (this.collaborator.id == this.myId || this.collaboratorList.indexOf(this.collaborator.id) > -1) return false;else return true;
	      }
	    }
	  },
	  methods: {
	    show: function show(joboffer) {
	      ...
	      if (this.joboffer.collaborators) {
	        this.joboffer.collaborators.map(function (item) {
	          _this.collaboratorList.push(item.profile_id);
	        });
	      }
	      this.showModal = true;
	    },
	    ...
	    add: function add() {
	      ...
	      connect.apiAsync('PUT', '/joboffers/' + this.joboffer.id, data).then(function (res) {
	        _firebaseChat2.default.addCollaboratorToChats(vm.collaborator, vm.joboffer);
	...
	module.exports = {
	  vuex: {
	    getters: {
	      ...
	      applicationList: _getters.getApplicationList,
	      getJobofferData: _getters.getJobofferData
	    }
	  },
	  methods: {
	    showCard: function showCard(application) {
	    ...
	    openChat: function openChat(profile) {
	      var vm = this;
	      _firebaseChat2.default.findOrCreateGroupChat(this.getJobofferData, profile).then(function (messageId) {
	        return vm.$router.go('/messenger/' + messageId);
	      }).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var connect = __webpack_require__(3);
	var addcollaborators = __webpack_require__(668);
	var bus = __webpack_require__(6);
	...
	module.exports = {
	  ...
	  ready: function ready() {
	    ...
	    if (this.joboffer && this.joboffer.collaborators) {
	      this.joboffer.collaborators.map(function (item) {
	        _this.collaboratorslist.push(item.profile);
	        _this.collaboratorsIds.push(item.profile_id);
	      });
	    }
	    bus.$on('joboffer:addcollaborators', function (data) {
	      _this.collaboratorslist.push(data);
	      _this.collaboratorsIds.push(data.id);
	    });
	  },
	  destroyed: function destroyed() {
	  ...
	  methods: {
	    ...
	    deleteCollaborators: function deleteCollaborators(item) {
	      var vm = this;
	      var itm = JSON.parse((0, _stringify2.default)(item));
	      vm.collaboratorsIds.$remove(item.id);
	      var data = {
	        collaborators: vm.collaboratorsIds
	      };
	      connect.apiAsync('PUT', '/joboffers/' + vm.joboffer.id, data).then(function (res) {
	        vm.joboffer = res;
	        vm.collaboratorslist.$remove(item);
	      }).catch(_notifsCenter2.default.fail).then(function (res) {
	        return _firebaseChat2.default.removeCollaboratorFromChats(itm, vm.joboffer, vm.applicationList);
	      }).catch(_notifsCenter2.default.fail);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  ready: function ready() {
	    if (this.company) {
	      this.unloadCompany();
	      var id = this.company.slug ? this.company.slug : this.company.uuid;
	      this.loadCompany(id);
	      this.loadCompanyJoboffers(this.company.id);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bus = __webpack_require__(6);
	var recomSide = __webpack_require__(241);
	var connector = __webpack_require__(3);
	var company = __webpack_require__(671);
	var confirm = __webpack_require__(695);
	var myJobFooter = __webpack_require__(673);
	var collaborators = __webpack_require__(670);


	var fb = __webpack_require__(198);

	module.exports = {
	  vuex: {
	    getters: {
	      joboffer: _getters.getJobofferData,
	      jobId: function jobId(_ref) {
	        var joboffer = _ref.joboffer;
	        return joboffer.data.id;
	      },
	      anonym: function anonym(_ref2) {
	        var account = _ref2.account;
	        return account.loaded === 'unauth';
	      },
	      isMine: _getters.isMine,
	      isReady: _getters.isReady
	    }
	  },
	  components: {
	    myJobFooter: myJobFooter,
	    recomSide: recomSide,
	    company: company,
	    confirm: confirm,
	  ...
	  computed: {
	    footer: function footer() {
	      if (this.isMine) return 'myJobFooter';else return '';
	    },
	  ...
	  methods: {
	    ...
	    closeJoboffer: function closeJoboffer() {
	      bus.$emit('confirm:open', 'Close JobOffer', 'Are you sure to close this job offer', 'confirm', this.jobId);
	    },
	    editJoboffer: function editJoboffer() {
	      window.location = '/addjoboffer/' + this.joboffer.id;
	    },
	    showmenu: function showmenu() {
	      this.listMe = !this.listMe;
	      if (this.listMe) $(document).bind('click', this.clickOut);else $(document).unbind('click', this.clickOut);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var applications = __webpack_require__(669);


	module.exports = {
	  vuex: {
	    getters: {
	      appliedIds: _getters.getAppliedIds
	    }
	  },
	  components: {
	  ...
	  computed: {
	    displayExpander: function displayExpander() {
	      if (this.appliedIds && this.appliedIds.length > 5) return true;else return false;
	    }
	  },
	  methods: {
	    showMore: function showMore(tab) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jobDetail = __webpack_require__(672);
	...
	module.exports = {
	  vuex: {
	    actions: {
	      loadJoboffer: _actions.loadJoboffer,
	      resetJoboffer: _actions.resetJoboffer
	    }
	  },
	  components: {
	    jobDetail: jobDetail,
	  ...
	  route: {
	    data: function data(_ref) {
	      ...
	      this.resetJoboffer(true);
	      this.loadJoboffer(to.params.jobId, true).then(function () {
	        return bus.$emit('jobofferDetails:ready');
	      }).catch(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  methods: {
	    open: function open(title, msg, type, obj) {
	      this.type = type || 'info';
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*doc\n---\ntitle: Colors\nname: colors\ncategory: Base CSS\n---\n\nColors: to be able to use the predefined colors, You need to import common/less/colors.less\n\n```html_example\n<style>\n@import \"../src/components/common/less/colors.less\"\n</style>\n<div class=\"size-32\" style=\"background-color: @color-navy-blue\">Click</div>\n```\n*/\n/* Mixin */\n.job-detail {\n  counter-reset: ol;\n}\n.job-detail .jd--header .jdh--publisher {\n  margin-left: 58px;\n}\n.job-detail .jd-section label,\n.job-detail .jd-section .jd-tab {\n  display: block;\n}\n.job-detail .jd-section label button,\n.job-detail .jd-section .jd-tab button {\n  border-radius: 0;\n  font-size: 1.2rem;\n  display: inline-block;\n  line-height: 2.8rem;\n  border-bottom: 2px solid transparent;\n  font-weight: bold;\n  margin-right: 4px;\n}\n.job-detail .jd-section label button.__active,\n.job-detail .jd-section .jd-tab button.__active {\n  border-bottom: 2px solid #6a6c6f;\n}\n.job-detail .jd-section.__panel {\n  min-width: 50%;\n}\n.job-detail .jd-section ul {\n  list-style: none;\n}\n.job-detail .jd-section ul li {\n  display: table-row;\n  line-height: 2rem;\n}\n.job-detail .jd-section ul li b {\n  display: table-cell;\n}\n.job-detail .jd-section ul li b:after {\n  content: ':';\n}\n.job-detail .jd-section ol {\n  list-style: none;\n}\n.job-detail .jd-section ol li::before {\n  counter-increment: ol;\n  content: counter(ol);\n  display: inline-block;\n  border-radius: 50%;\n  background-color: #e4e5e7;\n  color: #6a6c6f;\n  margin-right: 5px;\n  width: 1.5rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  text-align: center;\n}\n.job-detail .jd-section .jd-rec-list {\n  max-height: 200px;\n  overflow: hidden;\n  position: relative;\n  padding-bottom: 40px;\n  transition: 300ms;\n}\n.job-detail .jd-section .jd-rec-list.__expand {\n  max-height: 10000px;\n}\n.job-detail .jd-section .jd-rec-list .\\--show-more {\n  position: absolute;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  text-align: center;\n  background: linear-gradient(to top, #ffffff 0%, rgba(255, 255, 255, 0.8) 50%, rgba(255, 255, 255, 0) 100%);\n  width: 100%;\n  padding: 10px;\n}\n.job-detail .recomm-list ul {\n  list-style: none;\n}\n.job-detail .recomm-list h3 {\n  font-weight: normal;\n}\n.job-detail .recomm-list td {\n  vertical-align: middle;\n  padding: 4px;\n  border: none;\n}\n.job-detail .recomm-list td.rl-picture img {\n  float: right;\n}\n.job-detail .recomm-list .label {\n  font-size: 1rem;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".modal-mask[_v-795a97de] {\n  position: fixed;\n  z-index: 2000;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  -webkit-transition: opacity .3s ease;\n  transition: opacity .3s ease;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n}\n.modal-container[_v-795a97de] {\n  width: 500px;\n  padding: 0;\n  background-color: #fff;\n  border-radius: 2px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.33);\n  -webkit-transition: all .3s ease;\n  transition: all .3s ease;\n  border-radius: 8px 8px;\n}\n.modal-header[_v-795a97de] {\n  border-radius: 8px 8px 0 0;\n}\n.modal-body[_v-795a97de] {\n  margin: 0;\n  max-height: 600px;\n  overflow: hidden;\n  padding-bottom: 15px;\n}\n.modal-default-button[_v-795a97de] {\n  float: right;\n}\n.modal-footer[_v-795a97de] {\n  height: 35px;\n  background-color: WhiteSmoke ;\n}\n.modal-enter[_v-795a97de],\n.modal-leave[_v-795a97de] {\n  opacity: 0;\n}\n.modal-enter .modal-container[_v-795a97de],\n.modal-leave .modal-container[_v-795a97de] {\n  -webkit-transform: scale(1.1);\n  transform: scale(1.1);\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".down-menu[_v-e8af1ff4] {\n  position: absolute;\n  z-index: 100 !important;\n  list-style: none;\n  min-width: 120px;\n  border-radius: 2px;\n}\n.down-menu li[_v-e8af1ff4]:first-child {\n  border-top: 0;\n}\n.down-menu li[_v-e8af1ff4]:hover {\n  -webkit-transform: translateX(4px);\n          transform: translateX(4px);\n}\n.drop-down[_v-e8af1ff4] {\n  position: relative;\n  display: inline-block;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-795a97de&scoped=true!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./popup.confirm.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-795a97de&scoped=true!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./popup.confirm.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-e8af1ff4&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./joboffer.details.container.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-e8af1ff4&scoped=true!./../../../../node_modules/less-loader/index.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./joboffer.details.container.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./joboffer-details.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./joboffer-details.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div v-if=\"applicationList.length\" class=\"table-responsive recomm-list\">\n  <table class=\"table table-striped table-hover m-t-sm\">\n    <tbody>\n      <tr class=\"pointer\" v-for=\"item in applicationList\" track-by=\"$index\" @click=\"showCard(item)\" > \n        <td class=\"rl-picture\"><img :src=\"item.target.img\" class=\"user-image img-circle size-32\"></td> \n        <td><h6 class=\"m-none\">{{item.target.firstname}} {{item.target.lastname}}</h6></td>\n        <td class=\"client-status\">\n          <!-- <span v-if=\"item.status\" :class=\"{ 'label-success': item.status=='new'}\" class=\"label capital label-default \"> {{item.status}} </span> -->\n        </td>\n        <td> <span @click=\"openChat(item.target)\" class=\"hand font-1-2\">\n               <i class=\"material-icons\">&#xE0B7;</i>\n              <span class=\"capital\" v-ii18n=\"addNewSection\">Chat</span>\n             </span>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n</div>\n<section v-else class=\"fx-col fx-start-center placeholder\">\n  <i class=\"material-icons symbol\">&#xE85F;</i>\n  <p class=\"m-none capital\" v-ii18n=\"\">No one applied yet</p>\n</section>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"p-xs\">\n  <addcollaborators v-ref:addcollaborators></addcollaborators>\n    <div class=\"jd-section m-l-none\">\n    <label class=\"border-bottom\">\n      <div class=\"capital  __active\">\n        <span class=\"font-1-5 font-uppercase \" v-ii18n=\"collaborators\">collaborators</span>\n        <a v-show=\"collaboratorslist.length\" class=\"btn-floating disabled\">\n          <span class=\"text-orange p-sm\">{{collaboratorslist.length}}</span>\n        </a>\n      </div>\n    </label>\n  </div>\n  <section>\n    <div v-if=\"collaboratorslist.length\" class=\"table-responsive recomm-list m-t-sm\">\n      <table class=\"table table-striped table-hover\">\n        <tbody>\n          <tr v-for=\"item in collaboratorslist\" >\n            <td class=\"rl-picture\"><img :src=\"item.img\" class=\"user-image img-circle size-32\"></td>\n            <td><h6 class=\"m-none\">{{item.firstname}} {{item.lastname}}</h6></td>\n            <td><h6 class=\"m-none\">{{item.title}}</h6></td>\n            <td><span @click=\"deleteCollaborators(item)\" class=\"hand\"><i class=\"material-icons\">&#xE872;</i></span>\n            </td>\n          </tr>\n        </tbody>\n      </table>\n      <div v-else class=\"fx-col fx-start-center placeholder\">\n         <a v-if =\"collaboratorslist.length<3\" @click=\"addCollaborators\" class=\"waves-effect waves-light m-t-xs btn uppercase\"><i class=\"material-icons m-r-sm text-white\">&#xE7F0;</i>Add collaborators</a>\n      </div>\n    </div>\n    <section v-else class=\"fx-col fx-start-center placeholder\">\n      <i class=\"material-icons symbol\">&#xE85F;</i>\n      <!-- <h2 class=\"m-none capital\" v-ii18n=\"\">No one recommended yet</h2> -->\n      <p class=\"m-none capital\" v-ii18n=\"\">No collaborators click to add one</p>\n      <a @click=\"addCollaborators\" class=\"waves-effect waves-light m-t-sm btn uppercase\"><i class=\"material-icons m-r-sm text-white\">&#xE7F0;</i>Add collaborator</a>\n    </section>\n  </section>\n</div>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"jd-section p-xs\">\n  <label class=\"border-bottom\">\n    <div class=\"capital __active\">\n      <span class=\"font-1-5 font-uppercase \" v-ii18n=\"applications\">applications</span>\n          <a v-show=\"appliedIds.length\" class=\"btn-floating disabled\">\n        <span class=\"text-orange p-sm\">{{appliedIds.length}}</span>\n      </a>\n    </div>\n  </label>\n\n  <section class=\"jd-rec-list\" :class=\"{'__expand' : displayMore}\">\n    <div v-if=\"displayExpander\" @click=\"showMore\" class=\"hand pull-right\">\n      <span v-if=\"displayMore\" transition=\"fadeIn\"><i class=\"material-icons\">&#xE316;</i>show less</span>\n      <span v-else transition=\"fadeIn\"><i class=\"material-icons\">&#xE313;</i>show more</span>\n    </div>\n    <div v-show=\"activetab=='app'\"><applications></applications></div>\n  </section>\n\n</div>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"modal-mask\" transition=\"modal\" v-show=\"showme\" _v-795a97de=\"\">\n  <div class=\"modal-wrapper\" _v-795a97de=\"\">\n    <div class=\"modal-container\" _v-795a97de=\"\">\n      <div class=\"modal-header p-xs\" _v-795a97de=\"\">\n        <i class=\"fa {{config[type || 'confirm'].icon}} m-r-sm\" _v-795a97de=\"\"></i>\n        {{title || type}}\n      </div>\n      <div class=\"modal-body p-sm\" _v-795a97de=\"\">\n        <p _v-795a97de=\"\">\n          {{{msg}}}\n        </p>\n      </div>\n\n      <div class=\"modal-footer\" _v-795a97de=\"\">\n        <div class=\"pull-right p-xxs\" _v-795a97de=\"\">\n           <a @click=\"accept\" name=\"ok\" class=\" modal-action modal-close waves-effect waves-red btn-flat\" _v-795a97de=\"\">OK</a>\n           <a v-if=\"type=='confirm'\" name=\"cancel\" @click=\"cancel\" class=\" modal-action modal-close waves-effect waves-blue btn-flat\" _v-795a97de=\"\">cancel</a>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"row\" _v-e8af1ff4=\"\">\n  <div v-show=\"isReady\" class=\"job-detail border m-none m-b-md m-t-xs col s12  m7 p-none \" _v-e8af1ff4=\"\">\n    <confirm :name=\"'deleteJoboffer'\" _v-e8af1ff4=\"\"></confirm>\n    <recom-side _v-e8af1ff4=\"\"></recom-side>\n    <section v-if=\"joboffer\" class=\" bg-white \" _v-e8af1ff4=\"\">\n      <div class=\"fx-row right p-xs\" v-if=\"!anonym \" _v-e8af1ff4=\"\">\n\n       <div v-if=\"isMine\" id=\"drop-down\" class=\"drop-down hand font-1-2 bold\" @click=\"showmenu()\" _v-e8af1ff4=\"\">\n           <div class=\"p-xxs\" _v-e8af1ff4=\"\">\n              <i class=\"material-icons md-20 orange600 border\" _v-e8af1ff4=\"\"></i>\n            </div>\n            <div class=\"flesh\" v-show=\"listMe\" _v-e8af1ff4=\"\"></div>\n                  <ul class=\"border bg-white down-menu p-xxs m-none m-t-xs\" v-show=\"listMe\" _v-e8af1ff4=\"\">\n                   <li class=\"capital border-top p-xxs font-8\" @click=\"editJoboffer\" _v-e8af1ff4=\"\">\n                     <i class=\"material-icons m-r-xs\" _v-e8af1ff4=\"\"></i>Edit\n                      </li>\n                         <li class=\"capital border-top p-xxs font-8\" @click=\"closeJoboffer\" _v-e8af1ff4=\"\">\n                          <i class=\"material-icons m-r-xs\" _v-e8af1ff4=\"\"></i>close\n                      </li>\n                </ul>\n            </div>\n       <!--  <a v-if=\"isMine\" @click=\"closeJoboffer\" class=\"btn-floating btn waves-effect waves-light red\"><i class=\"material-icons\">&#xE14C;</i></a> -->\n        <div class=\"fx-row\" v-if=\"!isMine\" _v-e8af1ff4=\"\">\n          <span v-if=\"!joboffer.apply\" @click=\"apply\" class=\"border p-xs uppercase hand\" v-ii18n=\"apply\" _v-e8af1ff4=\"\"><i class=\"material-icons md-14 orange600\" _v-e8af1ff4=\"\"></i> apply</span>\n          <div v-if=\"joboffer.apply\" class=\"font-light font-9 m-l-xs uppercase\" disabled=\"\" _v-e8af1ff4=\"\">\n              <i class=\"material-icons\" _v-e8af1ff4=\"\"></i>\n          </div>\n        </div>\n      </div>\n<!-- end of top right options -->\n\n<!-- Company and Job Title -->\n      <div class=\"fx-row p-none p-l-md p-t-lg p-b-sm\" v-if=\"joboffer.company\" _v-e8af1ff4=\"\">\n        <a href=\"/company/{{joboffer.company.slug || joboffer.company.uuid}}\" class=\"pointer\" _v-e8af1ff4=\"\">\n          <img :src=\"joboffer.company &amp;&amp; joboffer.company.logo ? joboffer.company.logo : ''\" alt=\"company-logo\" class=\"img-rounded border size-48 company-image\" _v-e8af1ff4=\"\">\n        </a>\n        <div flex=\"\" class=\"m-l-sm\" _v-e8af1ff4=\"\">\n            <a href=\"/company/{{joboffer.company.slug}}\" _v-e8af1ff4=\"\"><h4 class=\"capital m-none break-word font-light font-1-2 hand text-info m-b-xs\" _v-e8af1ff4=\"\">{{joboffer.company.name}}</h4></a>\n            <h4 class=\"jdh--title capital font-light font-1-2 m-none break-word m-t-sm\" _v-e8af1ff4=\"\">{{joboffer.title}}</h4>\n        </div>\n      </div>\n<!-- end of Company and Job Title -->\n\n<!-- Category , city and job type -->\n      <div class=\"fx-row m-none p-l-md p-t-sm p-b-sm font-light bg-transparent \" _v-e8af1ff4=\"\">\n        <p class=\"m-none font-1 m-r-sm break-word\" v-if=\"joboffer.category\" _v-e8af1ff4=\"\">\n          <i class=\"material-icons md-14 orange600\" _v-e8af1ff4=\"\"></i>\n          <span class=\"font-light\" _v-e8af1ff4=\"\">{{joboffer.category.name}}</span>\n        </p>\n        <p class=\"m-none font-1 m-r-sm break-word\" v-if=\"joboffer.job_type\" _v-e8af1ff4=\"\">\n          <i class=\"material-icons md-14 orange600\" _v-e8af1ff4=\"\"></i>\n          <span class=\"font-light\" _v-e8af1ff4=\"\">{{joboffer.job_type.name}}</span>\n        </p>\n        <p class=\"m-none font-1 m-r-sm break-word\" v-if=\"joboffer.location\" _v-e8af1ff4=\"\">\n          <i class=\"material-icons md-14 orange600\" _v-e8af1ff4=\"\"></i>\n          <span class=\"font-light\" _v-e8af1ff4=\"\">{{joboffer.location.name}}</span>\n        </p>\n        <p class=\"m-none font-1 m-r-sm break-word\" _v-e8af1ff4=\"\">\n          <i class=\"material-icons md-14 orange600\" _v-e8af1ff4=\"\"></i>\n          <span class=\" font-light\" v-from-now=\"joboffer.release_date\" _v-e8af1ff4=\"\"></span>\n        </p>\n      </div>\n\n<!-- End of Category , city and job type -->\n    </section>\n\n<!-- Job Poster -->\n    <section class=\"fx-row fx-start-center m-t-sm  m-t-sm m-l-lg\" v-if=\"joboffer.responsible\" _v-e8af1ff4=\"\">\n      <div class=\"chip\" _v-e8af1ff4=\"\">\n        <img :src=\"joboffer.responsible.img ? joboffer.responsible.img : ''\" alt=\"{{joboffer.responsible.firstname}} {{joboffer.responsible.lastname}} photo\" class=\"circle user-image size-32 hand\" _v-e8af1ff4=\"\">\n        {{joboffer.responsible.firstname}} {{joboffer.responsible.lastname}}\n      </div>\n    </section>\n<!-- End of Job Poster -->\n\n    <section class=\"p-l-lg m-t-lg\" v-if=\"joboffer\" _v-e8af1ff4=\"\">\n      <div class=\"p-xs\" _v-e8af1ff4=\"\">\n        <label class=\"font-light font-1-5\" _v-e8af1ff4=\"\">\n          <span class=\"capital\" v-ii18n=\"description\" _v-e8af1ff4=\"\">Summary</span>\n        </label>\n        <p class=\"m-none m-b-xs break-word font-1 font-light\" _v-e8af1ff4=\"\">{{{joboffer.summary}}}</p>\n        <div class=\"m-t-sm break-word\" v-if=\"joboffer.tags\" _v-e8af1ff4=\"\">\n          <div v-for=\"tag in joboffer.tags\" class=\"chip m-l-xs m-b-sm\" _v-e8af1ff4=\"\">{{tag.name}}</div>\n          <!-- <span class=\"label label-warning p-xxs m-r-xs font-9 break-word\" v-for=\"tag in joboffer.tags\">{{tag.name}}</span> -->\n        </div>\n      </div>\n      <div class=\"fx-row\" _v-e8af1ff4=\"\">\n        <div v-if=\"showDetail\" class=\"jd-section p-xs\" flex=\"\" _v-e8af1ff4=\"\">\n          <label class=\"border-bottom m-b-lg\" _v-e8af1ff4=\"\">\n          </label>\n\n          <div class=\" p-none m-none m-t-xs font-light font-1-1\" _v-e8af1ff4=\"\">\n            <div v-show=\"joboffer.salary_max\" class=\"m-b-sm\" _v-e8af1ff4=\"\">\n              <span class=\"capital text-orange  \" v-ii18n=\"salary\" _v-e8af1ff4=\"\">salary</span>\n              <span class=\"m-l-sm m-r-xs \" _v-e8af1ff4=\"\">{{joboffer.salary_min | currency}} - {{joboffer.salary_max | currency}}</span>\n              <span class=\"font-8 font-light\" _v-e8af1ff4=\"\"> /month</span>\n            </div>\n            <!-- <li class=\"m-b-sm\"><b class=\"capital\" v-ii18n=\"reward\"></b><span class=\"m-l-sm\">{{joboffer.incentive | currency}}</span></li> -->\n            <div class=\"m-b-sm\" v-if=\"joboffer.degree\" _v-e8af1ff4=\"\">\n              <span class=\"capital text-orange\" v-ii18n=\"degree\" _v-e8af1ff4=\"\">degree</span>\n              <span class=\"m-l-sm\" _v-e8af1ff4=\"\">{{joboffer.degree.name}}</span>\n            </div>\n            <div v-show=\"joboffer.experience.value\" class=\"m-b-sm\" _v-e8af1ff4=\"\">\n              <span class=\"capital  text-orange\" v-ii18n=\"experience\" _v-e8af1ff4=\"\">experience</span>\n              <span class=\"m-l-sm\" _v-e8af1ff4=\"\">{{joboffer.experience.value}} years</span>\n            </div>\n          </div>\n\n        </div>\n      </div>\n    </section>\n    <collaborators v-if=\"!anonym &amp;&amp; isMine &amp;&amp; joboffer.state!='staged'\" :joboffer=\"joboffer\" _v-e8af1ff4=\"\"></collaborators>\n    <section v-if=\"!anonym &amp;&amp; joboffer.state!='staged'\" class=\"jd--footer\" _v-e8af1ff4=\"\">\n      <component :is=\"footer\" _v-e8af1ff4=\"\"></component>\n    </section>\n\n    <div class=\"p-l-lg\" _v-e8af1ff4=\"\">\n      <ul class=\"social-icons  icon-zoom list-unstyled list-inline p-l-sm\" _v-e8af1ff4=\"\">\n\n        <li @click=\"share\" _v-e8af1ff4=\"\"><i class=\"fa fa-facebook hand\" _v-e8af1ff4=\"\"></i></li>\n        <li @click=\"share\" _v-e8af1ff4=\"\"><i class=\"fa fa-twitter hand\" _v-e8af1ff4=\"\"></i></li>\n        <li @click=\"share\" _v-e8af1ff4=\"\"><i class=\"fa fa-google-plus hand\" _v-e8af1ff4=\"\"></i></li>\n        <li @click=\"share\" _v-e8af1ff4=\"\"><i class=\"fa fa-linkedin hand\" _v-e8af1ff4=\"\"></i></li>\n        <li @click=\"share\" _v-e8af1ff4=\"\"><i class=\"fa fa-tumblr hand\" _v-e8af1ff4=\"\"></i> </li>\n      </ul>\n    </div>\n\n    <div v-if=\"joboffer.state!='staged'\" class=\"fb-comments p-l-lg col m5\" :data-href=\"url\" data-numposts=\"5\" data-width=\"900\" _v-e8af1ff4=\"\"></div>\n  </div>\n  <company v-if=\"!isMine &amp;&amp; joboffer.company\" :company=\"joboffer.company\" _v-e8af1ff4=\"\"></company>\n\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/addcollaborators.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/all-applications.list.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/all-collaborators.list.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/company.details.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/joboffer.details.container.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/slaves/my-joboffer.details.footer.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/joboffer/view.joboffer.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/shared/popup.confirm.vue: named exports in *.vue files are ignored.")}
