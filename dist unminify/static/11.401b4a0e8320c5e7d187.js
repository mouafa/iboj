...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadAccount = _require.loadAccount;
	...
	module.exports = {
	  ...
	  methods: {
	    check: function check() {
	      ...
	      this.loadAccount().then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/profile/index.profile.vue: named exports in *.vue files are ignored.")}
